	...
	<div class="flip-card2">
        <div class="flip-card-inner2" id="sort_<?php echo $ROW3['id'];?>">
          <div class="inner-div19 d-flex">
            <div class="inner-div21 d-flex" onclick="show_cm(<?php echo $ROW3['id'];?>)">..<?php echo $ROW3['name'];?>..</div>
            <?php
            if(isset($ROW3['image'])){
        ...
        ?>
          ...
          <div class="flip-card-back2 p-3">
             <div class="inner-div52 d-flex" onclick="show_cm(<?php echo $ROW3['id'];?>)" >..<?php echo $ROW3['name'];?>..</div><br>
            	<?php echo $ROW3['need'];?>
          </div>
        </div>
      </div>
