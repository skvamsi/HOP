...
if(isset($_SESSION['id'])) {
    ...
    if(isset($_POST['year'])){
        ...
        $sql_total = "SELECT SUM(data) AS total_sum FROM barcharts";
        $sql_specific = "SELECT data FROM barcharts WHERE years = ? LIMIT 1";
        ...
        exec('pies_third.py');
         ...
         $sql = "SELECT * FROM datascience_images WHERE id = 4 LIMIT 1";
