...
function continuousLoadMessages() {
    var isVideoPlaying = false; // Flag to track if video is playing

    loadMessages(userId); // Load messages initially

    // Set interval to continuously load messages
    setInterval(function() {
        ...
        // If no video is playing, load messages and reset flag
        loadMessages(userId);
